...
import { Eye, EyeOff, KeyRound, PanelLeft, Upload, User as UserIcon } from '@/components/ui/icons';
...
import { QrLoginCard } from '../components/account/qr-login-card';
...
export function ContaPage(): React.ReactElement {
  ...
  if (!account) {
    return (
      <PageShell width="wide" className="flex min-h-64 items-center justify-center">
  ...
  return (
    <PageShell width="wide">
      ...
      <p className="text-xs text-[var(--color-app-muted)] text-center pt-2">
