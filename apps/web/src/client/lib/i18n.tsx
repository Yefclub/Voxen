...
const ptBRMessages = {
  ...
  'graph.descriptionAfter': 'e por hierarquia de pastas. Clique num nó para abrir.',
  'graph.searchPlaceholder': 'Filtrar nós e vizinhos…',
...
const enMessages: Record<I18nKey, string> = {
  ...
  'graph.title': 'Graph',
  'graph.descriptionBefore':
    'Visual map of your full library. Transcripts and notes connected by wiki-links',
  'graph.descriptionAfter': 'and folder hierarchy. Click a node to open it.',
  'graph.searchPlaceholder': 'Filter nodes and neighbors…',
