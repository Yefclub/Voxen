...
const ptBRMessages = {
  ...
  'chat.thinkingDuration': '{duration}',
  ...
  'chat.toolRunning': 'Executando',
  'chat.toolCompleted': 'Concluída',
  'chat.toolError': 'Falhou',
  'chat.toolApproval': 'Aguardando confirmação',
...
const enMessages: Record<I18nKey, string> = {
  ...
  'chat.toolApproval': 'Awaiting confirmation',
