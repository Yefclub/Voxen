...
const ptBRMessages = {
  ...
  'chat.emptyTitle': 'Oi, sou a {name}',
  'chat.emptyDescription':
    'Consulto sua base de conhecimento, indexo conteúdo novo e crio notas. Tudo com fonte e timestamp — sem alucinação.',
  'chat.card.library.title': 'Explorar biblioteca',
  'chat.card.library.hint': 'Veja o que está indexado',
  'chat.card.library.prompt': 'O que tem na minha biblioteca?',
  'chat.card.summary.title': 'Resumo do último',
  'chat.card.summary.hint': 'Síntese rápida',
  'chat.card.summary.prompt': 'Resuma o conteúdo mais recente da minha biblioteca.',
  'chat.card.ideas.title': 'Ideias dos últimos 3',
  'chat.card.ideas.hint': 'Conexões e padrões',
  'chat.card.ideas.prompt': 'Quais ideias principais dos últimos 3 conteúdos?',
  'chat.card.search.title': 'Procurar tema',
  'chat.card.search.hint': 'Busca FTS por palavra-chave',
  'chat.card.search.prompt': 'Busque "produtividade" na minha biblioteca.',
...
const enMessages: Record<I18nKey, string> = {
  ...
  'chat.charCount': '{count} chars',
  'chat.emptyTitle': 'Hi, I am {name}',
  'chat.emptyDescription':
    'I query your knowledge base, index new content, and create notes. Everything includes source and timestamp, without hallucination.',
  'chat.card.library.title': 'Explore library',
  'chat.card.library.hint': 'See what is indexed',
  'chat.card.library.prompt': 'What is in my library?',
  'chat.card.summary.title': 'Latest summary',
  'chat.card.summary.hint': 'Quick synthesis',
  'chat.card.summary.prompt': 'Summarize the most recent content in my library.',
  'chat.card.ideas.title': 'Ideas from last 3',
  'chat.card.ideas.hint': 'Connections and patterns',
  'chat.card.ideas.prompt': 'What are the main ideas from the last 3 pieces of content?',
  'chat.card.search.title': 'Search topic',
  'chat.card.search.hint': 'FTS keyword search',
  'chat.card.search.prompt': 'Search for "productivity" in my library.',
