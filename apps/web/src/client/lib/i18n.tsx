...
const ptBRMessages = {
  ...
  'graph.viewMap': 'Mapa',
  'graph.viewFull': 'Completo',
  'graph.viewMode': 'Visualização do mapa',
  'graph.switchToMap': 'Mostrar mapa recortado',
...
const enMessages: Record<I18nKey, string> = {
  ...
  'graph.viewMap': 'Map',
  'graph.viewFull': 'Full',
  'graph.viewMode': 'Map view',
  'graph.switchToMap': 'Show sliced map',
