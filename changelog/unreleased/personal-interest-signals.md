...
- Adicionamos histórico append-only, deduplicação diária de visualizações, restrições estritas no banco e limpeza em cascata quando o conteúdo é excluído definitivamente.
